...
<head>
	<title>Online Resume Personal Category Bootstrap Responsive website Template | Contact Me :: W3layouts</title>
	<!-- Meta tag Keywords -->
					...
					<ul class="navbar-nav ml-lg-auto text-lg-right text-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu text-lg-left text-center" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="index.html" title="">Skills</a>
								<a class="dropdown-item" href="index.html" title="">My Education</a>
								<a class="dropdown-item" href="index.html" title="">My Experience</a>
								<a class="dropdown-item" href="index.html" title="">Clients</a>
								<a class="dropdown-item" href="index.html" title="">Awards</a>
							</div>
						</li>
						<li class="nav-item">
